...
namespace QS.DBScripts.Models {
	/// <summary>
	/// Наполняет гарантированно существующую базу.
	/// Создание/удаление/перезапись схемы - ответственность вызывающего кода
	/// </summary>
	public abstract class BaseMySqlDbLoader : IDbCreatorModel {
		...
		public virtual Version NewBaseVersion => null;
