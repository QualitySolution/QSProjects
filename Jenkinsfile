   ...
   stage('Build Net4.x') {
    ...
    stage('Test net4.x'){
       try {
            ...
            sh "xvfb-run mono ${PACKAGES_LOCATION}/nunit.consolerunner/3.15.0/tools/nunit3-console.exe QSProjects/QS.LibsTest/bin/Debug/QS.LibsTest.dll --framework=mono-4.0"
       } catch (e) {}
       finally{
