...
namespace QSUpdater
{
	public class CheckUpdate
	{
		...
		public static string checkVersion, checkResult, serialNumber, newVersion;
		...
		public static void ShowDialog ()
		{
			try {
				...
				if (res.HasUpdate)
					...
					(res.UpdateDescription != String.Empty ? "<b>Информация об обновлении:</b>\n{2}" : "{2}"), 
					                                           res.NewVersion, MainSupport.ProjectVerion.Version, res.UpdateDescription));
				else
