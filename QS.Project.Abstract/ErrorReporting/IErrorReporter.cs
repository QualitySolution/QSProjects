...
namespace QS.ErrorReporting {
	...
	public interface IErrorReporter {
		...
		/// <returns><code>true</code> если сообщение отправлено</returns>
	...
	public enum ErrorType {
		/// <summary>
		/// Ошибка которую пользователь отправляет вручную. То есть он видит сообщение об ошибке, вводит какое-то пояснение в поле для ввода и отправляет ее разработчикам.
		/// </summary>
		User = 0,
		/// <summary>
