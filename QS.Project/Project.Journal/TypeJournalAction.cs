...
{
    public class TypeJournalAction : ITypeJournalAction
    {
        /// <summary>
        ...
        /// <param name="journalActionType">Тип действия, выполняемого с выделенными Node-ами</param>
        public TypeJournalAction(string title, Func<object[], bool> sensitiveFunc, Func<object[], bool> visibleFunc, Action<object[]> executeAction, JournalActionType journalActionType)
        {
        ...
        public JournalActionType ActionType { get; }
    }
}
