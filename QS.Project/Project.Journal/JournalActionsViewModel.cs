...
{
	public class JournalActionsViewModel : IJournalAction
	{
		public JournalActionsViewModel(string title, Func<object[], bool> sensitiveFunc, Func<object[], bool> visibleFunc, Action<object[]> executeAction)
		{
