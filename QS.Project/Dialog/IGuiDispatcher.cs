...
namespace QS.Dialog
{
	public interface IGuiDispatcher
	{
		...
		/// <summary>
		/// Выполняет все накопившиеся событи в GUI и возращает управление. Обычно нужно для 
		/// переристовки графических элементов внутри долго выполняющейся операции.
		/// </summary>
		void WaitRedraw();
		/// <summary>
		...
		/// <paramref name="sleepMilliseconds"/>Задержка в милисекундах между запусками циклов проверки и обработки событий.
