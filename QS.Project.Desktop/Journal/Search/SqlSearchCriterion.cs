...
namespace QS.Journal.Search {
	...
	public enum LikeMatchMode {
		/// <summary>
		/// Поиск подстроки в любом месте строки. Работает, в том числе и для чисел и других типов данных.
		/// </summary>
		StringAnywhere,
		/// <summary>
		/// Если строку можно преобразовать в беззнаковое число, то поиск осуществляется только при полном совпадении числа. То есть ввод "1" найдет только значение 1, а не 11, или 115.
		/// </summary>
		UnsignedNumberEqual,
	}
}
