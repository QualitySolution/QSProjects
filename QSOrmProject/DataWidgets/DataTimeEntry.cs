...
namespace QSOrmProject
{
	...
	public class DataTimeEntry : TimeEntry, IAdaptableControl, ICustomDataEvents, IPostableControl
	{
		/// <summary>
		...
		/// </param>
		public DataTimeEntry (string aMappings)
			: base ()
		{
		...
		/// Mappings with this widget <see cref="System.String"/>
		/// </param>
		public DataTimeEntry (object aDataSource, string aMappings)
			: base ()
		{
