...
namespace QSOrmProject
{
	public partial class CheckOperationDlg
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget QSOrmProject.CheckOperationDlg
			this.Name = "QSOrmProject.CheckOperationDlg";
			this.Title = global::Mono.Unix.Catalog.GetString ("Проверка зависимостей у удаляемого объекта");
			this.WindowPosition = ((global::Gtk.WindowPosition)(3));
			this.Modal = true;
			this.DestroyWithParent = true;
			this.Gravity = ((global::Gdk.Gravity)(5));
			// Container child QSOrmProject.CheckOperationDlg.Gtk.Container+ContainerChild
