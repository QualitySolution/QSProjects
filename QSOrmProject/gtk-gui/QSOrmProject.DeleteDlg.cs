...
namespace QSOrmProject
{
	public partial class DeleteDlg
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget QSOrmProject.DeleteDlg
			this.Name = "QSOrmProject.DeleteDlg";
			...
			this.Modal = true;
			// Internal child QSOrmProject.DeleteDlg.VBox
			...
			w7.Position = 0;
			// Internal child QSOrmProject.DeleteDlg.ActionArea
