...
{
    public class SideBySideFullDiffBuilder : ISideBySideDiffBuilder
    {
        ...
        public SideBySideFullDiffBuilder(IDiffer differ)
        {
        ...
        private void BuildWordDiffPieces(string oldText, string newText, List<DiffPiece> oldPieces, List<DiffPiece> newPieces)
        {
			...
			BuildDiffPieces(diffResult, oldPieces, newPieces, BuildCharacterDiffPieces);
        }

		private void BuildCharacterDiffPieces(string oldText, string newText, List<DiffPiece> oldPieces, List<DiffPiece> newPieces)
		{
			var diffResult = differ.CreateCharacterDiffs(oldText, newText, false);
