...
namespace QS.GtkUI.Views.Control
{
	public partial class EntityEntry
	{
		...
		protected virtual void Build()
		{
			...
			// Widget QS.GtkUI.Views.Control.EntityEntry
			global::Stetic.BinContainer.Attach(this);
			this.Name = "QS.GtkUI.Views.Control.EntityEntry";
			// Container child QS.GtkUI.Views.Control.EntityEntry.Gtk.Container+ContainerChild
