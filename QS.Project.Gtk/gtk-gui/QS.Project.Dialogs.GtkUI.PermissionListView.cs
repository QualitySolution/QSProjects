...
namespace QS.Project.Dialogs.GtkUI
{
	public partial class PermissionListView
	{
		...
		protected virtual void Build()
		{
			...
			// Widget QS.Project.Dialogs.GtkUI.PermissionListView
			global::Stetic.BinContainer.Attach(this);
			this.Name = "QS.Project.Dialogs.GtkUI.PermissionListView";
			// Container child QS.Project.Dialogs.GtkUI.PermissionListView.Gtk.Container+ContainerChild
