...
namespace QS.ErrorHandling.GtkUI
{
	public partial class ErrorMsgDlg
	{
		...
		protected virtual void Build()
		{
			...
			// Widget QS.ErrorHandling.GtkUI.ErrorMsgDlg
			this.WidthRequest = 1000;
			this.Name = "QS.ErrorHandling.GtkUI.ErrorMsgDlg";
			...
			this.Modal = true;
			// Internal child QS.ErrorHandling.GtkUI.ErrorMsgDlg.VBox
			...
			w17.Position = 0;
			// Internal child QS.ErrorHandling.GtkUI.ErrorMsgDlg.ActionArea
			...
			w19.Pixbuf = global::Gdk.Pixbuf.LoadFromResource("QSSupportLib.icons.send-error-report.png");
