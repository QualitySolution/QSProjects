...
namespace QS.Widgets.Gtk
{
	public partial class UserPresetPermissionWidget
	{
		...
		protected virtual void Build()
		{
			...
			// Widget QS.Widgets.Gtk.UserPresetPermissionWidget
			global::Stetic.BinContainer.Attach(this);
			this.Name = "QS.Widgets.Gtk.UserPresetPermissionWidget";
			// Container child QS.Widgets.Gtk.UserPresetPermissionWidget.Gtk.Container+ContainerChild
