...
namespace QS.Validation
{
	public partial class ResultsListDlg
	{
		...
		protected virtual void Build()
		{
			...
			// Widget QS.Validation.ResultsListDlg
			this.Name = "QS.Validation.ResultsListDlg";
			...
			this.Modal = true;
			// Internal child QS.Validation.ResultsListDlg.VBox
			...
			w5.Position = 1;
			// Internal child QS.Validation.ResultsListDlg.ActionArea
