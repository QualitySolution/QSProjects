...
namespace QS.ErrorReporting.GtkUI
{
	public partial class ErrorMsgDlg
	{
		...
		protected virtual void Build()
		{
			...
			// Widget QS.ErrorReporting.GtkUI.ErrorMsgDlg
			this.WidthRequest = 1000;
			this.Name = "QS.ErrorReporting.GtkUI.ErrorMsgDlg";
			...
			this.Modal = true;
			// Internal child QS.ErrorReporting.GtkUI.ErrorMsgDlg.VBox
			...
			w17.Position = 0;
			// Internal child QS.ErrorReporting.GtkUI.ErrorMsgDlg.ActionArea
