...
namespace QS.Validation.GtkUI
{
	public partial class ResultItem
	{
		...
		protected virtual void Build()
		{
			...
			// Widget QS.Validation.GtkUI.ResultItem
			global::Stetic.BinContainer.Attach(this);
			this.Name = "QS.Validation.GtkUI.ResultItem";
			// Container child QS.Validation.GtkUI.ResultItem.Gtk.Container+ContainerChild
