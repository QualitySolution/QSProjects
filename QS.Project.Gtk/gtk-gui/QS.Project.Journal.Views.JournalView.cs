...
namespace QS.Project.Journal.Views
{
	public partial class JournalView
	{
		...
		protected virtual void Build()
		{
			...
			// Widget QS.Project.Journal.Views.JournalView
			global::Stetic.BinContainer.Attach(this);
			this.Name = "QS.Project.Journal.Views.JournalView";
			// Container child QS.Project.Journal.Views.JournalView.Gtk.Container+ContainerChild
