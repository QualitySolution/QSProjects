...
namespace QS.Views.GtkUI
{
	public partial class EntityJournalActionsView
	{
		...
		protected virtual void Build()
		{
			...
			// Widget QS.Views.GtkUI.EntityJournalActionsView
			global::Stetic.BinContainer.Attach(this);
			this.Name = "QS.Views.GtkUI.EntityJournalActionsView";
			// Container child QS.Views.GtkUI.EntityJournalActionsView.Gtk.Container+ContainerChild
