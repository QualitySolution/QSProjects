...
namespace QS.Widgets.GtkUI
{
	public partial class RepresentationEntry
	{
		...
		protected virtual void Build()
		{
			...
			// Widget QS.Widgets.GtkUI.RepresentationEntry
			global::Stetic.BinContainer.Attach(this);
			this.Name = "QS.Widgets.GtkUI.RepresentationEntry";
			// Container child QS.Widgets.GtkUI.RepresentationEntry.Gtk.Container+ContainerChild
