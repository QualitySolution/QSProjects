...
namespace QS.Widgets.Gtk
{
	public partial class UserEntityPermissionWidget
	{
		...
		protected virtual void Build()
		{
			...
			// Widget QS.Widgets.Gtk.UserEntityPermissionWidget
			global::Stetic.BinContainer.Attach(this);
			this.Name = "QS.Widgets.Gtk.UserEntityPermissionWidget";
			// Container child QS.Widgets.Gtk.UserEntityPermissionWidget.Gtk.Container+ContainerChild
