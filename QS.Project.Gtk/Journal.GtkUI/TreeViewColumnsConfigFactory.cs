...
namespace QS.Journal.GtkUI
{
	...
	{
		private static Dictionary<Type, Func<IJournalViewModel, IColumnsConfig>> columnsConfigs = new Dictionary<Type, Func<IJournalViewModel, IColumnsConfig>>();
		...
		public static IColumnsConfig Resolve(IJournalViewModel journalViewModel)
		{
