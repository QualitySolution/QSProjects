...
namespace QSProjectsLib
{
	public partial class GetPassword
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget QSProjectsLib.GetPassword
			this.Name = "QSProjectsLib.GetPassword";
			this.Title = global::Mono.Unix.Catalog.GetString ("Доступ к серверу БД");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Modal = true;
			// Internal child QSProjectsLib.GetPassword.VBox
			...
			global::Gtk.Table.TableChild w2 = ((global::Gtk.Table.TableChild)(this.table1 [this.entryLogin]));
			...
			w6.Expand = false;
			w6.Fill = false;
			// Internal child QSProjectsLib.GetPassword.ActionArea
